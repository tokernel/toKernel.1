 ...
 * Hook File for HTTP and CLI modes which will be run 
 * after main addon call. 
 * 
 * NOTE: Make sure that the option 'allow_hooks'  
 ...
 */ 
 ...
 /* Disconnect from mysql server if connection established */
 $this->lib->mysql->disconnect();
